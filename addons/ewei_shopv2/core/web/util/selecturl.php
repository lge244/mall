...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		{
			$allUrls[] = array( 'name' => m('plugin')->getName('groups'), 'list' => array( array('name' => '拼团首页', 'url' => mobileUrl('groups', NULL, $full), 'url_wxapp' => ''), array('name' => '活动列表', 'url' => mobileUrl('groups/job', NULL, $full), 'url_wxapp' => ''), array('name' => '我的订单', 'url' => mobileUrl('groups/orders', NULL, $full), 'url_wxapp' => ''), array('name' => '我的团', 'url' => mobileUrl('groups/team', NULL, $full), 'url_wxapp' => '') ) );
		}
		...
		{
			$allUrls[] = array( 'name' => m('plugin')->getName('qa'), 'list' => array( array('name' => '帮助首页', 'url' => mobileUrl('qa', NULL, $full), 'url_wxapp' => ''), array('name' => '全部分类', 'url' => mobileUrl('qa/job', NULL, $full), 'url_wxapp' => ''), array('name' => '全部问题', 'url' => mobileUrl('qa/question', NULL, $full), 'url_wxapp' => '') ) );
		}
