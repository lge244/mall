...
<script>
    $('.butt').click(function () {
        $.post("http://www.hmj.cn/app/index.php?i=2&c=entry&m=ewei_shopv2&do=mobile&r=order.create.buy", {
            "total":<?php  echo $total;?>,
            "createInfo":<?php  echo json_encode($createInfo)?>
        }, function (res) {
            if (res.code==0){
                alert(res.msg);
                window.location.href ="http://www.hmj.cn/app/index.php?i=2&j=2&c=entry&m=ewei_shopv2&do=mobile&r=order&status=1"
            }else{
                alert(res.msg)
            }
