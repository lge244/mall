...
<div class='fui-content  navbar'>
    ...
    <?php  if(strlen($trade['refundcontent']) >0) { ?>
    <div class="refuse_reason">
        退款须知：<br/><?php  echo $trade['refundcontent'];?>
    </div>
    <?php  } ?>
    ...
    <div class="fui-cell-group">
        ...
        <div class="fui-cell-info c000" style="    display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-box-align: center;-webkit-align-items: center;-ms-flex-align: center;align-items: center;">
            ￥<input type="number" id="price" class='fui-input' placeholder="请输入需要退的金额" value="<?php  echo number_format($order['refundprice'],2)?>" />
            <!--value="<?php  if(!empty($refund['id'])) { ?><?php  echo $show_price?><?php  } ?>"-->
        </div>
    ...
    <div class="fui-cell">
        ...
        <div class="fui-cell-info">
            ...
            <ul class="fui-images fui-images-sm" id="images">
                ...
                <li style="background-image:url(<?php  echo tomedia($v)?>)" class="image image-sm" data-filename="<?php  echo $v;?>">
...
<span class='text-danger'>*提示:您可退款的最大金额为￥<?php  echo number_format($order['refundprice'],2)?></span>
</div>
...
<div class="fui-cell-group">
    ...
    <div class="fui-cell">
        ...
        <div class="fui-cell-info "></div>
        <div class="fui-cell-remark noremark"><?php  if(empty($refund['content'])) { ?>无<?php  } else { ?><?php  echo $refund['content'];?> <?php  } ?></div>
        </div>
...
<div class='fui-footer text-right'>
    ...
    <a external data-nocache="true" href="<?php  echo mobileUrl('order/refund/refundexpress',array('id'=>$order['id'], 'express'=>$refund['rexpress'], 'expresscom'=>$refund['expresscom'],'expresssn'=>$refund['rexpresssn']))?>"><div class="btn btn-sm  btn-default-o">查看换货物流</div></a>
    <?php  } ?>

    <?php  if($refund['status']==3 || $refund['status']==4) { ?>
    <a data-nocache="true" class="btn btn-sm btn-danger-o" href='#page-refund-express'><?php  if(empty($refund['express'])) { ?>填写<?php  } else { ?>修改<?php  } ?>快递单号</a>
    <?php  } ?>
